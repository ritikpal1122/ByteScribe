"""
Seed the problems table with batch 14 problems (NeetCode 150 missing problems).

Idempotent — skips problems whose slug already exists.

Usage:
    cd backend
    python scripts/seed_problems_batch14.py
"""
...
from scripts.seed_problems_data_batch14 import PROBLEMS_BATCH14
...
async def main() -> None:
    ...
    added = skipped = 0
    total = len(PROBLEMS_BATCH14)

    print(f"Seeding {total} batch 14 problems ...\n")
    ...
    async with session_factory() as session:
        ...
        for i, p in enumerate(PROBLEMS_BATCH14, 1):
