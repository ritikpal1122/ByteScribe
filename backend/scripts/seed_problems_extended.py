"""
Seed the problems table with extended LC problems (beyond Blind 75).

Idempotent — skips problems whose slug already exists.

Usage:
    cd backend
    python scripts/seed_problems_extended.py
"""
...
async def main() -> None:
    ...
    added = skipped = 0
    total = len(PROBLEMS_EXTENDED)

    print(f"Seeding {total} extended problems ...\n")
    ...
    async with session_factory() as session:
        ...
        for i, p in enumerate(PROBLEMS_EXTENDED, 1):
