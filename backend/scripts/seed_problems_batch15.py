"""
Seed the problems table with batch 15 problems (Grind 75 missing problems).

Idempotent — skips problems whose slug already exists.

Usage:
    cd backend
    python scripts/seed_problems_batch15.py
"""
...
from scripts.seed_problems_data_batch15 import PROBLEMS_BATCH15
...
async def main() -> None:
    ...
    added = skipped = 0
    total = len(PROBLEMS_BATCH15)

    print(f"Seeding {total} batch 15 problems ...\n")
    ...
    async with session_factory() as session:
        ...
        for i, p in enumerate(PROBLEMS_BATCH15, 1):
